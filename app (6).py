...
def series_probs(nr_home: float, nr_away: float, home_adv: float,
    ...
    return {
        ...
        # home team covers these lines:
        'p_home_p35': mgn(aw, 3.5),   # sweep only (4-0)
        'p_home_p25': mgn(aw, 2.5),   # 4-0 or 4-1
        'p_home_p15': mgn(aw, 1.5),   # 4-0, 4-1 or 4-2
        # away team covers:
        'p_away_p35': mgn(bw, 3.5),
        'p_away_p25': mgn(bw, 2.5),
        'p_away_p15': mgn(bw, 1.5),
    }
